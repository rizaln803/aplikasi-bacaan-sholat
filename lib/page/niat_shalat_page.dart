import 'dart:convert';
import 'package:flutter_application_1/model/model_niat.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart' as rootBundle;

class NiatShalat extends StatefulWidget {
  const NiatShalat({super.key});

  @override
  State<NiatShalat> createState() => _NiatShalatState();
}

class _NiatShalatState extends State<NiatShalat> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 233, 234, 253),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("Bacaan niat shalat wajib 5 waktu",
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 12,
                        fontWeight: FontWeight.bold
